...
// const name = useRef(null);
  ...
  return (
    <div>
      ...
      <form
        className=" absolute w-full md:w-3/12 overflow-hidden max-w-screen-sm h-auto my-28 mx-auto bg-opacity-80 rounded-lg right-0 left-0 p-8 bg-black text-white"
